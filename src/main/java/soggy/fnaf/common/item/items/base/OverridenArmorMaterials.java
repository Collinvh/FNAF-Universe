...
public enum OverridenArmorMaterials  implements ArmorMaterial {
    ...
    FREDDY("freddy_mask", 6, new int[]{3,3,3,3}, 0, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(Items.LEATHER);
    });
    ...
    private OverridenArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> supplier) {
        this.name = name;
